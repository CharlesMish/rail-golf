...
export const REFERENCE_SHOTS = Object.freeze({
  ...
  "timber-bank": Object.freeze({ railIndex: 0, yaw: -15.5, elevation: 20, charge: 0.73 }),
  ...
  "ruckus-line": Object.freeze({ railIndex: 2, yaw: 1.2, elevation: 44.5, charge: 0.458 }),
});
...
export function chargeFromHold(milliseconds) {
  ...
  return clamp(milliseconds / (RAIL_RULES.chargeSeconds * 1000), 0, 1);
}
