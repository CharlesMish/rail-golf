...
const cards={'/lab/lines':{'mill-delivery':'gate','switchback-gallery':'gate','lumber-cascade':'lumber','open-line':'saw'},'/lab/courtyard-diverter':{'courtyard-diverter':'gate'}};
...
export function validateShareLine(value){
 ...
 if(value.v!==1||value.world!==SHARE_WORLD||!Object.hasOwn(cards,value.route)||!Object.hasOwn(cards[value.route],value.card)||cards[value.route][value.card]!==value.station)throw Error('Unsupported line world, route, card or station');
