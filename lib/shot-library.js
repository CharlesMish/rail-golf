...
export function normalizeShotLibrary(value, holes) {
  ...
  for (const hole of holes) {
    ...
    const normalize = line => {
      ...
      const lab = ['diverter-floor','courtyard-diverter'].includes(hole.id);
      ...
      return { ...(lab ? {environment:{floor:line.environment.floor},environmentAfter:{floor:line.environmentAfter.floor}} : {}), holeId:hole.id, stationId:line.stationId, windId:line.windId, projectileId:line.projectileId,
