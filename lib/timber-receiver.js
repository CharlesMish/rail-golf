...
// v1: shorter/lower and 14 m toward the lumber bays, opening the Walk aiming view.
// Experimental overlay only. The original yard, launch stations and OOB volume stay intact.
export const TIMBER_RECEIVER=Object.freeze({x:45,y:5,z:134,width:1.2,height:10,depth:18,yaw:-25});
