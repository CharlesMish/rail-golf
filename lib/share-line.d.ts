...
export type ShareLineV1={v:1;build:string;world:'timber-courtyard';route:'/lab/lines'|'/lab/courtyard-diverter'|'/lab/timber-receiver';card:string;station:string;rail:number;yaw:number;elevation:number;speed:number;environment:FloorEnvironment};
