...
export function scoreLine(ledger,rules=PLACEHOLDER_RULES,variety=VARIETY_RULE,runRule=RUN_RULE){
 ...
 return {ruleSet:'placeholder-v4',run,runDistance,nonCanonical:true,awards,claimIds,uniqueFeatureCount,secondary,claimTotal:awards.reduce((n,a)=>n+a.points,0),total:awards.reduce((n,a)=>n+a.points,0)+secondary+run,
