...
export function buildTravellingTee(scene,root,materials,shadows){
 ...
 // Shared-equipment presentation only. TOUR moves this deck before release; the
 // shared session launches from the captured station with no platform inheritance.
