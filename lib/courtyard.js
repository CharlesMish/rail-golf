...
export const COURTYARD_SKIP_PAD = Object.freeze({ x: 0, z: 84, halfWidth: 6, halfDepth: 6, minY: .2, maxY: .5, verticalSpeed: 10.5, forwardKick: 0 });
const common = {
...
export const COURTYARD_HOLES = Object.freeze([
  ...
  Object.freeze({ ...common, station: YARD_STATIONS.lumber, id:'lumber-cascade', number:'03', shortName:'CASCADE', name:'Lumber Cascade',
    ...
    instruction:'Land on the lime Receiving Bay to clear. A gentle charge reaches the high stack; extra loft can carry over. Stamp: 1 → 2 → 3 → landing.',
