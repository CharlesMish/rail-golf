...
export type RangeEvent={kind:string;label?:string;reason?:string;state?:'A'|'B';last?:RangeRecord};
export function createMechanismSession(scene:Scene,world:ReturnType<typeof buildMechanismRange>,emit?:(event:RangeEvent)=>void):{
