...
export const VERTICAL_V0_SOLIDS = Object.freeze([
...
// Three separated wall faces, not stair treads: a launch can pass beside,
// above or between them. Existing v0 structures remain byte-for-byte records.
export const VERTICAL_RETURN_LADDER = Object.freeze([
  Object.freeze({id:'ladder-low',label:'LOW CHEEK RETURN',zone:'ladder',x:-10,y:17,z:43,w:14,h:10,d:1.4,pitch:20,yaw:-65}),
  Object.freeze({id:'ladder-middle',label:'CROSS-VOID RETURN',zone:'ladder',x:12,y:28,z:64,w:14,h:10,d:1.4,pitch:-12,yaw:28}),
  Object.freeze({id:'ladder-high',label:'UPPER CHEEK RETURN',zone:'ladder',x:-12,y:29,z:95,w:15,h:10,d:1.4,pitch:-18,yaw:-20}),
]);
export const VERTICAL_SOLIDS = Object.freeze([...VERTICAL_V0_SOLIDS,...VERTICAL_RETURN_LADDER]);
