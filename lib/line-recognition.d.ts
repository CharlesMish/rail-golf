...
export type RedirectFeature={id:string;kind:string;label:string};
...
export function createRedirectTracker(gates?:typeof REDIRECT_GATES):{beginStep(velocity:VectorLike,seconds:number):void;contact(feature:RedirectFeature|undefined,body:string,point:VectorLike):void;endStep(position:VectorLike,velocity:VectorLike,seconds:number):LineEvidence|null};
