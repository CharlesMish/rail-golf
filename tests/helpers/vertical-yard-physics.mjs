...
Logger.LogLevels=0;
export function verticalHarness(havok,config=VERTICAL_YARD_LAB){
 ...
 const world=config.buildWorld(scene,new TransformNode('vertical',scene),materials,{addShadowCaster(){},removeShadowCaster(){}});
 const session=createSpatialSession(scene,world,config);
